    ...
    <%
       ...
       <body>
        <div class="box2">
            ...
            <center>
         <form name="form1" method="post" action="SaveMarks">
            ...
            <tr><td><%=rs.getString(2)%></td><td><%=rs.getString(3)%></td>
                <% if(ex<=13){%>
                <td><input type="number" min="0"max="10" value="<%=rs.getString(ex)%>"  name="<%=rs.getString(1)%>ex<%=ex%>"></td>
                <%}else{%>
                <td><input type="number" min="0" max="100" value="<%=rs.getString(ex)%>"  name="<%=rs.getString(1)%>ex<%=ex%>"></td>
                   <%}%>               <%}%>
            </tr>
